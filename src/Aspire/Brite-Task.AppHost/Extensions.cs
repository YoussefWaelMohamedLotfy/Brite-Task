...
{
    public static IResourceBuilder<ExecutableResource> AddEfMigrate(
...
{
    public static IResourceBuilder<ProjectResource> WithDataPopulation(
...
internal static class PostgresDatabaseResourceExtensions
{
    public static IResourceBuilder<PostgresDatabaseResource> WithResetDbCommand(
        this IResourceBuilder<PostgresDatabaseResource> resourceBuilder
    )
    {
        return resourceBuilder.WithCommand(
            "reset",
